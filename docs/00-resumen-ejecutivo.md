...
|---|---|---|
| 1 | País o países de operación (moneda, impuestos, facturación electrónica, regulación de medición y de transparencia de precios, ley de datos personales, región de Google Cloud) | Un solo país en el MVP; todo lo específico del país como parámetro de tenant; facturación electrónica en fase 3 mediante un adaptador |
...
| 3. Interoperabilidad | 20 a 28 semanas | Gateway OCPP 2.0.1, roaming OCPI 2.2.1, Plug&Charge, facturación electrónica, optimización energética | Primer acuerdo de roaming y primer cargador 2.0.1 en producción |
