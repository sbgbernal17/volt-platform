...
- [x] 2026-09-25: huellas de la firma de Google Play entregadas (punto 0e completo). Play Console mostró tres certificados de firma emitidos por Google el 24-09-2026 (válidos hasta 2056): el clásico (`8A:37:7D:27:7D:F9:F8:96:4C:97:F9:EF:B8:89:B3:5B:67:85:7E:48`), el híbrido clásico (`19:0D:A4:37:88:70:26:99:9B:7C:12:3B:48:67:B3:02:A5:63:3D:9B`) y el híbrido poscuántico ML-DSA-65 (`35:B8:3F:74:B4:6B:C3:EE:76:2D:45:32:E3:A4:16:60:5C:9B:90:88`). La clave de Google Maps del proyecto prod quedó restringida al paquete `co.supercargadores.volt` con esas tres huellas más la del keystore de EAS (`C2:D1:…:F1:92`), y el flujo *Clave de Google Maps (Android)* las trae por defecto. Los certificados son públicos; no se guardan en el repositorio, bastan las huellas.
