...
- [x] 2026-09-24: huella SHA-1 del keystore de EAS entregada (punto 0e, parcial): el flujo *Clave de Google Maps (Android)* crea la clave restringida en el proyecto prod y la guarda como variable sensible en EAS; falta la huella de la firma de Google Play (ver 0e).
